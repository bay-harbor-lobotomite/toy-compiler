...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_L_SQUARE = 8,                   /* L_SQUARE  */
  YYSYMBOL_R_SQUARE = 9,                   /* R_SQUARE  */
  ...
  YYSYMBOL_PERIOD = 16,                    /* PERIOD  */
  YYSYMBOL_COMMA = 17,                     /* COMMA  */
  YYSYMBOL_SEMICOLON = 18,                 /* SEMICOLON  */
  YYSYMBOL_BANG = 19,                      /* BANG  */
  YYSYMBOL_B_EQ = 20,                      /* B_EQ  */
  YYSYMBOL_EQ = 21,                        /* EQ  */
  YYSYMBOL_EQ_EQ = 22,                     /* EQ_EQ  */
  YYSYMBOL_LE = 23,                        /* LE  */
  YYSYMBOL_LE_EQ = 24,                     /* LE_EQ  */
  YYSYMBOL_GR = 25,                        /* GR  */
  YYSYMBOL_GR_EQ = 26,                     /* GR_EQ  */
  YYSYMBOL_BIT_AND = 27,                   /* BIT_AND  */
  YYSYMBOL_BIT_OR = 28,                    /* BIT_OR  */
  YYSYMBOL_BOOL_OR = 29,                   /* BOOL_OR  */
  YYSYMBOL_BOOL_AND = 30,                  /* BOOL_AND  */
...
static const char *const yytname[] =
{
  ...
  "STRING", "L_PAREN", "R_PAREN", "L_SQUARE", "R_SQUARE", "L_BRACE",
  "R_BRACE", "PLUS", "MINUS", "STAR", "SLASH", "PERIOD", "COMMA",
  "SEMICOLON", "BANG", "B_EQ", "EQ", "EQ_EQ", "LE", "LE_EQ", "GR", "GR_EQ",
  "BIT_AND", "BIT_OR", "BOOL_OR", "BOOL_AND", "ELSE", "FALSE", "FOR", "IF",
  "PRINT", "RETURN", "SUPER", "THIS", "TRUE", "WHILE", "INT", "CHAR",
  "STRUCT", "END_OF_FILE", "$accept", "program", "statement_list",
...
{
       3,   -17,   -18,    27,    23,    -3,   -18,    -4,     7,    27,
     -18,    -2,   -18,   -18,   -18,   -18,    27,    27,    27,    27,
     -18,    14,   -18,    14,    14,    14,    14
};
...
{
       1,     2,    11,     3,     9,    22,     1,     2,    21,     3,
      16,    17,    18,    19,    15,    23,    24,    25,    26,    16,
      17,    18,    19,    12,    14,    20,    16,    17,    18,    19,
...
{
       3,     4,     3,     6,    21,     7,     3,     4,     9,     6,
      12,    13,    14,    15,    18,    16,    17,    18,    19,    12,
      13,    14,    15,     0,     5,    18,    12,    13,    14,    15,
       3,     4,    -1,     6,    -1,    -1,    -1,    -1,    -1,    -1,
      -1,    44
};
...
{
       0,     3,     4,     6,    46,    47,    48,    49,    50,    21,
       3,    50,     0,    44,    48,    18,    12,    13,    14,    15,
      18,    50,     7,    50,    50,    50,    50
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* program: statement_list END_OF_FILE  */
